...
export default {
  ...
  contacts: {
    ...
    card: {
      ...
      destroySuccess: 'Group disbanded',
      blockSuccess: 'Blocked',
      unblockSuccess: 'Unblocked',
      deleteConfirmTitle: 'Delete Contact',
      deleteConfirmMessage: 'Delete contact "{name}" and clear chat history?',
      blockConfirmTitle: 'Block',
      blockConfirmMessage: 'Block "{name}"? They will not be able to send you messages.',
      unblockConfirmTitle: 'Unblock',
      unblockConfirmMessage: 'Unblock "{name}"?',
      leaveConfirmTitle: 'Leave Group',
      leaveConfirmMessage: 'Leave group "{name}"?',
      destroyConfirmTitle: 'Disband Group',
      destroyConfirmMessage: 'Disband group "{name}"? This cannot be undone.',
    },
  },
  features: {
