...
/** UIKit 版本：从 package.json 的 uikit-im 依赖声明中提取（支持 npm 版本区间 ^3.7.10 与历史 file:./tgz 写法） */
const uikitImVersion = extractVersion(pkg.dependencies?.['@easemob-community/uikit-im']) ?? '1.0.0'
